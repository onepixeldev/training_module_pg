			...
			if (!empty($other_allw_detl)) {
				foreach ($other_allw_detl as $oad) {
                    ...
                    <tr>
                        ...
                        <td class="text-center col-md-1">
                            <input name="sca_amt_rm_approve_hod" class="form-control" type="number" id="amountAppHod" value="' . $oad->SCA_AMT_RM_APPROVE_HOD . '">
                        </td>
                        <td class="text-center col-md-1">
                            <input name="sca_amt_foreign_approve_hod" class="form-control" type="number" id="amountAppHodFor" value="' . $oad->SCA_AMT_FOREIGN_APPROVE_HOD . '">
                        </td>
                        <td class="text-center col-md-1">
                            <input name="sca_amt_rm_approve_rmic" class="form-control" type="number" id="amountAppRmic" value="' . $oad->SCA_AMT_RM_APPROVE_RMIC . '">
                        </td>
                        <td class="text-center col-md-1">
                            <input name="sca_amt_foreign_approve_rmic" class="form-control" type="number" id="amountAppForRmic" value="' . $oad->SCA_AMT_FOREIGN_APPROVE_RMIC . '">
                        </td>
