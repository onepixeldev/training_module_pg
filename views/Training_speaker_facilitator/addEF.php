	...
	<h5 class="panel-heading bg-success txt-color-black"><b>Details</b></h5>
		...
		<div class="form-group">
			...
			<div class="form-group"-->
				...
				<div class="col-md-4">
					<input name="form[organization]" placeholder="Organization" class="form-control" type="text">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<input name="form[hp_no]" placeholder="Mobile phone number" class="form-control" type="text">
				</div>
			<!--/div>
			<div class="form-group"-->
				<label class="col-md-2 control-label"><b>Email </b><b><font color="red">* </font></b></label>
				<div class="col-md-4">
					<input name="form[email]" placeholder="Email address" class="form-control" type="text">
				</div>
			</div>
			<div class="form-group">
