<form class="form-horizontal" method="post">
    ...
    <div class="modal-body">
        ...
        <div>
			...
			<b>Status :</b> <?php echo $es_name->ES_STATUS?><br>
        	<b>External Speaker Name :</b> <?php echo $es_name->ES_SPEAKER_NAME?><br>
        </div>
    </div>
...
<script>
	$(document).ready(function(){	
		$('form').submit(function (e) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('deleteES')?>',
				data: {esID: '<?php echo $es_id ?>'},
				dataType: 'JSON',
