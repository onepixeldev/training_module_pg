				...
				foreach ($external_facilitator_list as $efl) {
					...
					<tr>
						...
						<td class="text-center">
							<button type="button" class="btn btn-info btn-xs detail_ef_btn" title="Details"><i class="fa fa-info-circle"></i> Detail</button>
							<button type="button" class="btn btn-success btn-xs edit_ef_btn" title="Edit Record"><i class="fa fa-edit"></i> Edit</button>
							<button type="button" class="btn btn-danger btn-xs delete_ef_btn" title="Delete Record"><i class="fa fa-trash"></i> Delete</button>
						</td>
					</tr>
					';
					$no++;
