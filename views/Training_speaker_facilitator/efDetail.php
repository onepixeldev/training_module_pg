<form class="form-horizontal" method="post">
	...
	<h5 class="panel-heading bg-success txt-color-black"><b>Details</b></h5>
		...
		<div class="form-group">
				<label class="col-md-2 control-label font-weight-bold"><b>Status </b></label>
				<div class="col-md-3">
			...
			<div class="form-group">
				<label class="col-md-2 control-label"><b>H/P No. </b></label>
				<div class="col-md-3">
		...
		<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<input class="form-control" type="text" value="<?php if (!empty($ef_country_desc->CM_COUNTRY_DESC)){echo $ef_country_desc->CM_COUNTRY_DESC;}?>" readonly>
				</div>
			<!--/div>
			<div class="form-group"-->
				<label class="col-md-2 control-label"><b>State </b></label>
				<div class="col-md-4">
					<input class="form-control" type="text" value="<?php if (!empty($ef_state_desc->SM_STATE_DESC)){echo $ef_state_desc->SM_STATE_DESC;}?>" readonly>
				</div>
			</div>
