								...
								if (!empty($basic_ext)) {
									...
									foreach ($basic_ext as $be) {
										...
										<tr>
											...
											<td>".$be->ES_IC_NO."</td>
											<td>".$be->ES_DEPT."</td>
											<td>".$be->ES_POSITION."</td>
											<td>".$be->ES_STATUS."</td>
											<td class='text-center col-sm-1'>
													<button type='button' class='detail_es btn btn-sm btn-primary'><i class='fa fa-search'></i> Detail</button>
													<button type='button' class='edit_es btn btn-sm btn-success'><i class='fa fa-edit'></i> Edit</button>
													<button type='button' class='delete_es btn btn-sm btn-danger'><i class='fa fa-delete'></i> Delete</button>
											</td>
										</tr>";
									}
								} else {
