	...
	<div class="modal-header btn-primary">
		...
		<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<input class="form-control" type="text" value="<?php if (!empty($es_state_country_desc->CM_COUNTRY_DESC)){echo $es_state_country_desc->CM_COUNTRY_DESC;}?>" readonly>
				</div>
			<!--/div>
			<div class="form-group"-->
				<label class="col-md-2 control-label"><b>State </b></label>
				<div class="col-md-4">
					<input class="form-control" type="text" value="<?php if (!empty($es_state_country_desc->SM_STATE_DESC)){echo $es_state_country_desc->SM_STATE_DESC;}?>" readonly>
				</div>
			</div>
		</div>					
