<form class="form-horizontal" method="post">
    <div class="modal-header btn-primary">
        <h4 class="modal-title" id="myModalLabel">Add New Training Level</h4>
    </div>
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
				<input name="form[code]" placeholder="Training level code" class="form-control" type="text">
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-3 control-label"><b>Training Level</b> <b><font color="red">* </font></b></label>
            <div class="col-md-9">
				<input name="form[training_level]" placeholder="Training level description" class="form-control" type="text">
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-3 control-label"><b>Training Level (English)</b></label>
            <div class="col-md-9">
				<input name="form[training_level_english]" placeholder="Training level description (English)" class="form-control" type="text">
            </div>
        </div>
    </div>
...
<script>	
	$(document).ready(function(){	
		$('form').submit(function (e) { 
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('saveTL')?>',
				data: data,
				dataType: 'JSON',
