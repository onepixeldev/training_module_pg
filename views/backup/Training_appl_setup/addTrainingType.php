<form class="form-horizontal" method="post">
    ...
    <div class="modal-body">
		...
		<div class="form-group">
			<label class="col-md-3 control-label">Counted </label>
			<div class="col-md-3">
		...
		<div class="form-group">
			<label class="col-md-3 control-label">Training Evaluation </label>
			<div class="col-md-3">
		...
		<div class="form-group">
			<label class="col-md-3 control-label">Service Book </label>
			<div class="col-md-3">
