				...
				foreach ($training_category_list as $tc) {
					...
					<tr>
						...
						<td class="text-center col-md-1">
							<button type="button" class="btn btn-success btn-xs edit_tc" title="Edit Record"><i class="fa fa-edit"></i></button>
							<button type="button" class="btn btn-danger btn-xs delete_tc" title="Delete Record"><i class="fa fa-trash"></i></button>
						</td>
					</tr>
					';
				}
