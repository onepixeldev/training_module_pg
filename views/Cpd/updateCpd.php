<form id="updCpdStaff" class="form-horizontal" method="post">
    <div class="modal-header btn-success">
        <h4 class="modal-title txt-color-white" id="myModalLabel">Update CPD</h4>
    </div>
    <div class="modal-body">
        <div id="updCpdStaffAlert">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary upd_staff_cpd"><i class="fa fa-save"></i> Save</button>
    </div>
</form>