<form class="form-horizontal" method="post">
    ...
    <div class="modal-body">
        ...
        <div>
			...
			<b>Code :</b> <?php echo $tet_code?><br>
        	<b>Description :</b> <?php echo $tet_desc->TET_DESC?><br>
        </div>
    </div>
...
<script>
	$(document).ready(function(){	
		$('form').submit(function (e) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('deleteTET')?>',
				data: {tetCode: '<?php echo $tet_code ?>', tacCode: '<?php echo $tet_desc->TET_CATEGORY?>'},
				dataType: 'JSON',
