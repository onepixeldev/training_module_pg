<form class="form-horizontal" method="post">
    ...
    <div class="modal-body">
        ...
        <div>
			...
			<b>Code :</b> <?php echo $tcl_code?><br>
        	<b>Description :</b> <?php echo $tcl_desc->TCL_COMPETENCY_DESC?><br>
        </div>
    </div>
...
<script>
	$(document).ready(function(){	
		$('form').submit(function (e) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('deleteTCL')?>',
				data: {codeTCL: '<?php echo $tcl_code ?>'},
				dataType: 'JSON',
