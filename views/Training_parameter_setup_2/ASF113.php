                    ...
                    <div role="content">
                        ...
                        <!-- end widget edit box -->
                            <ul id="myTab1" class="nav nav-tabs bordered">
								...
								<li class="">
                                    <a style="color:#000 !important" href="#s3" data-toggle="tab" aria-expanded="false"> Effectiveness Grading</a>
                                </li>
								<li class="">
                                    <a style="color:#000 !important" href="#s4" data-toggle="tab" aria-expanded="false"> Competency Level</a>
                                </li>
								<li class="">
                                    <a style="color:#000 !important" href="#s5" data-toggle="tab" aria-expanded="false"> Training Memo</a>
                                </li>
								<li class="">
                                    <a style="color:#000 !important" href="#s6" data-toggle="tab" aria-expanded="false"> Training Component</a>
                                </li>
								<li class="">
                                    <a style="color:#000 !important" href="#s7" data-toggle="tab" aria-expanded="false"> External Agency Setup</a>
                                </li>
								<li class="">
                                    <a style="color:#000 !important" href="#s8" data-toggle="tab" aria-expanded="false"> Cost / Fee Setup</a>
                                </li>
                            </ul>
							<!-- myTabContent1 -->
									...
									<div style="max-height:500px;overflow-y:auto;overflow-x:hidden">
										...
										<tbody> 
											...
											<tr data-parm-id="<?php //echo $hod_memo2->HP_PARM_CODE?>">
												...
												<td class="text-left">
													<button type="button" class="btn btn-success btn-xs edit_hod_mem" value="<?php echo $hod_memo2->HP_PARM_NO?>" title="Edit Record"><i class="fa fa-edit"></i> Update</button>
												</td>
											</tr>
											<tr data-parm-id="<?php //echo $hod_memo3->HP_PARM_CODE?>">
												...
												<td class="text-left">
													<button type="button" class="btn btn-success btn-xs edit_hod_mem" value="<?php echo $hod_memo3->HP_PARM_NO?>" title="Edit Record"><i class="fa fa-edit"></i> Update</button>
												</td>
											</tr>
										</tbody>
										</table>
									...
									<div style="max-height:500px;overflow-y:auto;overflow-x:hidden">
										...
										<tbody> 
											<tr>
												...
												<td class="text-left">
													<button type="button" class="btn btn-success btn-xs edit_hod_mem" data-parm-id="<?php echo $tr_eva_memo->HP_PARM_CODE?>" value="<?php echo $tr_eva_memo->HP_PARM_NO?>" title="Edit Record"><i class="fa fa-edit"></i> Update</button>
												</td>
											</tr>
										</tbody>
										</table>
									...
									<div style="max-height:500px;overflow-y:auto;overflow-x:hidden">
										...
										<tbody> 
											<tr>
												...
												echo $por?></td>
												<td class="text-left">
													<button type="button" class="btn btn-success btn-xs edit_hod_mem" data-parm-id="<?php echo $tr_eva_por->HP_PARM_CODE?>" value="<?php echo $tr_eva_memo->HP_PARM_NO?>" title="Edit Record"><i class="fa fa-edit"></i> Update</button>
												</td>
											</tr>
										</tbody>
										</table>
									...
									<div class="row">
										<div class="col-sm-3">
											<div class="form-group text-right">
												<label><b>Grading Type</b></label>
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group text-left">
												<?php echo form_dropdown('typeEGS', array('EFFECTIVENESS'=>'EFFECTIVENESS'), 'EFFECTIVENESS', 'class="form-control listFilterEGS" id="typeEGS"'); ?>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="text-left">   
															...
															foreach ($tr_mod_comp as $tmc) {
																...
																<tr>
																	...
																	<td class="text-center col-md-2	">
																		<button type="button" class="btn btn-success btn-xs edit_tmc" title="Edit Record"><i class="fa fa-edit"></i> Edit</button>
																		<button type="button" class="btn btn-danger btn-xs delete_tmc" title="Delete Record"><i class="fa fa-trash"></i> Delete</button>
																	</td>
																</tr>
																';
															}
											...
											<table class="table table-bordered table-hover">
												<tbody> 
													<tr>
														...
														<td class="text-left">
															<button type="button" class="btn btn-success btn-xs edit_eas" data-parm-id="<?php echo $max_interval->HP_PARM_CODE?>" value="<?php echo $max_interval->HP_PARM_NO?>" title="Edit Record" ><i class="fa fa-edit"></i> Update</button>
														</td>
													</tr>
												</tbody>
											</table>
											<table class="table table-bordered table-hover">
												<tbody>
													<tr>
														...
														<td class="text-left">
															<button type="button" class="btn btn-success btn-xs edit_eas" data-parm-id="<?php echo $guideline_url->HP_PARM_CODE?>" value="<?php echo $guideline_url->HP_PARM_NO?>" title="Edit Record"><i class="fa fa-edit"></i> Update</button>
														</td>
													</tr>
												</tbody>
											</table>
...
<script>
	...
	// filter list training effectiveness grading setup 
	$('.listFilterEGS').change(function() {
		var typeEGS = $('#typeEGS').val();
