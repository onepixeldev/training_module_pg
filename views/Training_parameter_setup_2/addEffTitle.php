<form class="form-horizontal" method="post">
    <div class="modal-header btn-primary">
        <h4 class="modal-title" id="myModalLabel">Add New Effectiveness Title</h4>
    </div>
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
				<input name="form[order]" placeholder="List Priority (number)" class="form-control" type="text">
            </div>
        </div>

        <div class="form-group">
            <div class="col-md-4">
				<input name="form[codetac]" class="form-control" type="hidden" value="<?php echo $code_tac?>" readonly>
            </div>
        </div>
...
<script>	
	$(document).ready(function(){	
		$('form').submit(function (e) { 
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('saveTET')?>',
				data: data,
				dataType: 'JSON',
