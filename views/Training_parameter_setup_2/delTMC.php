<form class="form-horizontal" method="post">
    ...
    <div class="modal-body">
        ...
        <div>
			...
			<b>Code :</b> <?php echo $tmc_code?><br>
        	<b>Description :</b> <?php echo $tmc_desc->TMC_COMPONENT_DESC?><br>
        </div>
    </div>
...
<script>
	$(document).ready(function(){	
		$('form').submit(function (e) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('deleteTMC')?>',
				data: {tmcCode: '<?php echo $tmc_code ?>'},
				dataType: 'JSON',
