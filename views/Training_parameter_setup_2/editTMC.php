<form class="form-horizontal" method="post">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
				<input name="form[code]" class="form-control" type="text" value="<?php echo $tmc_code?>" readonly>
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-3 control-label"><b>Description</b> <b><font color="red">* </font></b></label>
            <div class="col-md-9">
				<input name="form[description]" placeholder="Training module component description" class="form-control" type="text" value="<?php echo $tmc_desc->TMC_COMPONENT_DESC?>">
            </div>
        </div>
    </div>
...
<script> 
	$(document).ready(function(){	
		$('form').submit(function (e) { 
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('updateTMC')?>',
				data: data,
				dataType: 'JSON',
