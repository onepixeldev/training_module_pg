<p>
	<div class="well">
		...
		<div class="row">
			<table class="table table-bordered table-hover" id="tbl_training_tab3_list">
			<thead>
			<tr>
					...
					foreach ($training_list as $training) {
						...
						<tr data-training-code="' . $training->TH_REF_ID . '">
							...
							<td class="text-center col-md-1">
                                                            <button type="button" class="btn btn-primary btn-xs select_training_tab3_btn"><i class="fa fa-check-square-o"></i> Select</button>
							</td>
						</tr>
						';
					}
