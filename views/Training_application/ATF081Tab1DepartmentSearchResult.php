<p>
	<div class="well">
		...
		<div class="row">
			<table class="table table-bordered table-hover" id="tbl_dept_tab1_list">
			<thead>
			<tr>
					...
					foreach ($dept_list as $dept) {
						...
						<tr data-dept-code="' . $dept->DM_DEPT_CODE . '">
							...
							<td class="text-center col-md-1">
                                                            <button type="button" class="btn btn-primary btn-xs select_deptTab1_btn"><i class="fa fa-check-square-o"></i> Select</button>
							</td>
						</tr>
						';
					}
