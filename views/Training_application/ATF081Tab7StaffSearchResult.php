<p>
	<div class="well">
		...
		<div class="row">
			<table class="table table-bordered table-hover" id="tbl_staff_tab7_list">
			<thead>
			<tr>
					...
					foreach ($staff_list as $staff) {
						...
						<tr data-staff-id="' . $staff->SM_STAFF_ID . '">
							...
							<td class="text-center col-md-1">
                                                            <button type="button" class="btn btn-primary btn-xs select_staffTab7_btn"><i class="fa fa-check-square-o"></i> Select</button>
							</td>
						</tr>
						';
					}
