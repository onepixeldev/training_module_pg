<?php echo $this->lib->title('Training / Approve Training by MPE for External Agency', $screen_id) ?>
...
<section id="widget-grid" class="">
    <div class="jarviswidget  jarviswidget-color-blueDark jarviswidget-sortable" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" role="widget">
        <header role="heading">
            ...
            <h2>ATF143 - Approve Training by MPE for External Agency</h2>				
...
<script>
	...
	$.ajax({
		type: 'POST',
		url: '<?php echo $this->lib->class_url('getTrainingList5')?>',
	...
	$('#training_list').on('click','.staff_list_btn', function() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo $this->lib->class_url('trStaffList3')?>',
            data: {'refid' : refid},
            beforeSend: function() {
		    ...
		    buttons: {
		        yes: function () {
                    ...
                    if (mpe_date == '') {
						...
						$.alert({
							title: 'Alert!',
							content: 'Please enter <b>MPE Date</b>.',
							type: 'red'
						});
						return;
					}
					...
					$.ajax({
						type: 'POST',
						url: '<?php echo $this->lib->class_url('appTrApplicantMPE')?>',
						data: {'refid' : refid, 'staffID' : staffIDArr, 'remark' : remarkArr, 'mpe_date' : mpe_date},
						dataType: 'JSON',
						success: function(res) {
							if (res.sts==1) {
                                hide_loading();
		...
		$.confirm({
		    ...
		    buttons: {
		        yes: function () {
					...
					$.ajax({
						type: 'POST',
						url: '<?php echo $this->lib->class_url('rejTrApplicantMPE')?>',
						data: {'refid' : refid, 'staffID' : staffIDArr, 'remark' : remarkArr, 'mpe_date' : mpe_date},
						dataType: 'JSON',
						success: function(res) {
							if (res.sts==1) {
