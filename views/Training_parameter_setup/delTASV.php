<form class="form-horizontal" method="post">
    ...
    <div class="modal-body">
        ...
        <div>
			...
			<b>Code :</b> <?php echo $tasv_code?><br>
            <b>Description :</b> <?php echo $tasv_desc->TAS_DESC?><br>
            <b>Type :</b> <?php echo $tasv_desc->TAS_TYPE?><br>
            <b>Assessment Type :</b> <?php echo $tasv_desc->TAS_ASSESSMENT_TYPE?><br>
        </div>
    </div>
...
<script>
	$(document).ready(function(){	
		$('form').submit(function (e) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('deleteTASV')?>',
				data: {codeTASV: '<?php echo $tasv_code ?>', typeTASV: '<?php echo $tasv_desc->TAS_TYPE ?>'},
				dataType: 'JSON',
