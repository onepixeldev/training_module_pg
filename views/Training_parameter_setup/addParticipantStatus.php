<form class="form-horizontal" method="post">
    <div class="modal-header btn-primary">
        <h4 class="modal-title" id="myModalLabel">Add New Participant Status</h4>
    </div>
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
				<input name="form[code]" placeholder="Participant status code" class="form-control" type="text">
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-3 control-label"><b>Participant Status</b> <b><font color="red">* </font></b></label>
            <div class="col-md-9">
				<input name="form[participant_status]" placeholder="Participant status description" class="form-control" type="text">
            </div>
        </div>
    </div>
...
<script>	
	$(document).ready(function(){	
		$('form').submit(function (e) { 
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('saveTPS')?>',
				data: data,
				dataType: 'JSON',
