<form class="form-horizontal" method="post">
    <div class="modal-header btn-primary">
        <h4 class="modal-title" id="myModalLabel">Add New Remark Setup</h4>
    </div>
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
				<input name="form[no]" placeholder="Number" class="form-control" type="text">
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-3 control-label"><b>Remark</b> <b><font color="red">* </font></b></label>
            <div class="col-md-9">
				<input name="form[remark]" placeholder="Remark description" class="form-control" type="text">
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-9">
				<input name="form[module]" class="form-control" type="hidden" value="APPLICATION" readonly>
            </div>
        </div>
    </div>
...
<script>	
	$(document).ready(function(){	
		$('form').submit(function (e) { 
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('saveRS')?>',
				data: data,
				dataType: 'JSON',
