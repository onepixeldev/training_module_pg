<form class="form-horizontal" method="post">
    ...
    <div class="modal-body">
        ...
        <div>
            ...
            <b>Grading Type :</b> <?php echo $tg_type?><br>
			<b>Mark/Code :</b> <?php echo $tg_code?><br>
        	<b>Description :</b> <?php echo $tg_desc->TAG_GRADE_DESC?><br>
        </div>
    </div>
...
<script>
	$(document).ready(function(){	
		$('form').submit(function (e) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('deleteTG')?>',
				data: {tg_code: '<?php echo $tg_code ?>', tg_type: '<?php echo $tg_type ?>'},
				dataType: 'JSON',
