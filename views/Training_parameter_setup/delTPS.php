<form class="form-horizontal" method="post">
    ...
    <div class="modal-body">
        ...
        <div>
			...
			<b>Code :</b> <?php echo $tps_code?><br>
        	<b>Participant Status :</b> <?php echo $tps_desc->TPS_DESC?><br>
        </div>
    </div>
...
<script>
	$(document).ready(function(){	
		$('form').submit(function (e) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('deleteTPS')?>',
				data: {codeTPS: '<?php echo $tps_code ?>'},
				dataType: 'JSON',
