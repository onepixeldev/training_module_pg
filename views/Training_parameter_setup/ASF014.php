                        ...
                        <!-- end widget edit box -->
                            ...
                            <div id="myTabContent1" class="tab-content padding-10">
                                <div class="tab-pane fade active in" id="s1">
									<h4 class="panel-heading bg-color-blueDark txt-color-white">Training Application Setup</h4>
									<div style="max-height:500px;overflow-y:auto;overflow-x:hidden">
										<table class="table table-bordered table-hover">
										<tbody> 
											<tr>
												<td class="text-left col-md-3"><b>Maximum Application</b></td>
												<td class="text-center col-md-1"><?php echo $max_appl->HP_PARM_DESC?> time(s)<b><font color="red">*</font></b></td>
												<td class="text-left">
													<button type="button" class="btn btn-success btn-xs max_appl_btn" value="<?php echo $max_appl->HP_PARM_DESC?>" title="Edit Record"><i class="fa fa-edit"></i> Update</button>
												</td>
											</tr>
										</tbody>
										</table>
									...
									<br>
									<h4 class="panel-heading bg-color-blueDark txt-color-white">Training Type</h4><br>
                                ...
                                <div class="tab-pane fade" id="s2">
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="form-group text-left">
												<?php echo form_dropdown('sStatus', array('ALL'=>' ALL ','Y'=>'ACTIVE','N'=>'INACTIVE'), 'Y', 'class="form-control listFilter" id="trStatus"'); ?>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="text-left">   
									...
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="form-group text-left">
												<?php echo form_dropdown('sStatus', array('ALL'=>' ALL ','Y'=>'YES','N'=>'NO'), 'Y', 'class="form-control listFilter" id="stTraining"'); ?>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="text-left">   
								...
								<div class="tab-pane fade" id="s11">
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="form-group text-left">
												<?php echo form_dropdown('sStatus', array('ALL'=>' ALL ','FACILITATOR'=>'FACILITATOR','TRAINING'=>'TRAINING'), 'FACILITATOR', 'class="form-control listFilterAst" id="aStsS"'); ?>
											</div>
										</div>
										<div class="col-sm-3">
											<div class="text-left">   
...
<script>
	...
	// EDIT - Training Application Setup (Training Type)
	$('.max_appl_btn').click(function () {
		var thisBtn = $(this);
		var maxAppl = thisBtn.val();
		//alert(recCode);
		...
		if (maxAppl) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('editMA')?>',
				data: {'maxAppl' : maxAppl},
				success: function(res) {
