<form class="form-horizontal" method="post">
    <div class="modal-header btn-primary">
        <h4 class="modal-title" id="myModalLabel">Add New Training Requirement Type</h4>
    </div>
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
				<input name="form[requirement_type]" placeholder="Training requirement type description" class="form-control" type="text">
            </div>
        </div>
    </div>
...
<script>	
	$(document).ready(function(){	
		$('form').submit(function (e) { 
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('saveTRT')?>',
				data: data,
				dataType: 'JSON',
