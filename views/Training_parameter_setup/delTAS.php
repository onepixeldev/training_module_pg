<form class="form-horizontal" method="post">
    ...
    <div class="modal-body">
        ...
        <div>
			...
			<b>Code :</b> <?php echo $tas_code?><br>
        	<b>Attendance Status :</b> <?php echo $tas_desc->TAS_DESC?><br>
        </div>
    </div>
...
<script>
	$(document).ready(function(){	
		$('form').submit(function (e) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo $this->lib->class_url('deleteTAS')?>',
				data: {tasCode: '<?php echo $tas_code ?>'},
				dataType: 'JSON',
