...
class Training_parameter_setup_2 extends MY_Controller
{
    ...
    public function saveTET()
    {
        ...
        if ($status == 1) {
            // Check whether record already exists
            $recCode = $this->mdl->getTETDetail($codeTET, $codeTAC);
    ...
    public function saveTFS()
    {
        ...
        // form / input validation
        $rule = array('code' => 'required|max_length[10]', 'description' => 'required|max_length[100]',
        'minimum_range' => 'required|max_length[10]', 'maximum_range' => 'required|max_length[10]',
    ...
    _____________________*/
    // get training 
    public function effGraSetup()
    {
        // get available records
        $data['eff_gra_se'] = $this->mdl->getEffGraSetup();
    ...
    public function saveEGS()
    {
        ...
        // form / input validation
        $rule = array('mark' => 'required|is_natural_no_zero|max_length[10]','description' => 'required|max_length[100]','tag_grade_type' => 'max_length[20]');
    ...
    public function updateEGS()
    {
        ...
        // form / input validation
        $rule = array('description' => 'required|max_length[100]');
